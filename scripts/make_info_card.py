...
# ===========================================================================
HOST = "rodri"   # shown as  rodri@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Fundador @ Syncra Labs"),
    ("kv", "Creator", "IA en espanol  @rodrigov.ia"),
    ("kv", "Focus", "Automatizaciones & agentes de IA"),
    ("kv", "Based", "Espana  -  remoto"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Automation", "n8n, GoHighLevel, Make"),
    ("kv", "AI", "Claude, GPT, agentes MCP"),
    ("kv", "Web", "Next.js, Supabase, Vercel"),
    ("kv", "Content", "Reels, SEO, funnels"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Formo a gente para vivir de la IA"),
    ("bul", "Implemento IA en negocios locales"),
]
